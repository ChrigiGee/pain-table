...
uses
  ...
  DBDateTimePicker, DCPrc6, DCPrc4, DCPmd5, DCPripemd160, DCPsha1, ZDataset,
  ZConnection, Forms, Controls, Graphics, Dialogs, ComCtrls, StdCtrls, DBCtrls,
  Buttons, DBExtCtrls, ExtCtrls, XMLPropStorage, Menus, IniPropStorage;
...
uses medikamente_unit, monat_jahr_unit, my_mail_unit, smtpsend,
  ssl_openssl, Mimepart, Mimemess, INIFiles, TConfiguratorUnit,
...
begin
  ...
  ZConnection1.Database := './sql/migraenetagebuch.sql3db';
...
//  ZConnection1.AutoCommit :=True;
 ...
 {
  Form1.ZQuery1.Options:=sqoAutoCommit;
   Form1.ZQuery2.UpdateMode:='umUpdateAll';
   Form1.ZQuery3.UpdateMode:='umUpdateAll';
   Form1.ZQuery4.UpdateMode:='umUpdateAll';
   Form2.ZQuery1.UpdateMode:='umUpdateAll';
   Form3.ZQuery1.UpdateMode:='umUpdateAll';
   Form3.ZQuery2.UpdateMode:='umUpdateAll';
  }
 ...
 {erstellt die Tabellle DateTime}
  ...
  ZQuery2.SQL.Text := 'DROP TABLE IF EXISTS tblJahr';
  ZQuery2.ExecSQL;
  ZConnection1.commit;
        Application.OnException := @AppException;
  ...
  ZQuery2.ExecSQL;
  ZConnection1.commit;
  ZQuery2.SQL.Text := 'INSERT INTO tblJahr VALUES (NULL, "2010")';
  ZQuery2.ExecSQL;
  ZQuery2.SQL.Text := 'INSERT INTO tblJahr VALUES (NULL, "2011")';
  ZQuery2.ExecSQL;
  ZQuery2.SQL.Text := 'INSERT INTO tblJahr VALUES (NULL, "2012")';
  ZQuery2.ExecSQL;
  ZQuery2.SQL.Text := 'INSERT INTO tblJahr VALUES (NULL, "2013")';
  ZQuery2.ExecSQL;
  ZQuery2.SQL.Text := 'INSERT INTO tblJahr VALUES (NULL, "2014")';
  ZQuery2.ExecSQL;
  ZQuery2.SQL.Text := 'INSERT INTO tblJahr VALUES (NULL, "2015")';
  ZQuery2.ExecSQL;
  ZQuery2.SQL.Text := 'INSERT INTO tblJahr VALUES (NULL, "2016")';
  ZQuery2.ExecSQL;
  ZQuery2.SQL.Text := 'INSERT INTO tblJahr VALUES (NULL, "2017")';
  ZQuery2.ExecSQL;
  ZQuery2.SQL.Text := 'INSERT INTO tblJahr VALUES (NULL, "2018")';
  ZQuery2.ExecSQL;
  ZQuery2.SQL.Text := 'INSERT INTO tblJahr VALUES (NULL, "2019")';
  ZQuery2.ExecSQL;
  ZQuery2.SQL.Text := 'INSERT INTO tblJahr VALUES (NULL, "2020")';
  ZQuery2.ExecSQL;
  ZQuery2.SQL.Text := 'INSERT INTO tblJahr VALUES (NULL, "2009")';
  ZQuery2.ExecSQL;
  ZConnection1.commit;
        Application.OnException := @AppException;

  {Löscht die Tabelle Monat}
  ZQuery3.SQL.Text := 'DROP TABLE IF EXISTS tblMonth';
  ZQuery3.ExecSQL;
  ZConnection1.commit;
           Application.OnException := @AppException;
  ...
  ZQuery3.ExecSQL;
  ZConnection1.commit;
  ZQuery3.SQL.Text := 'INSERT INTO tblMonth VALUES (NULL, "Januar")';
  ZQuery3.ExecSQL;
  ZQuery3.SQL.Text := 'INSERT INTO tblMonth VALUES (NULL, "Februar")';
  ZQuery3.ExecSQL;
  ZQuery3.SQL.Text := 'INSERT INTO tblMonth VALUES (NULL, "März")';
  ZQuery3.ExecSQL;
  ZQuery3.SQL.Text := 'INSERT INTO tblMonth VALUES (NULL, "April")';
  ZQuery3.ExecSQL;
  ZQuery3.SQL.Text := 'INSERT INTO tblMonth VALUES (NULL, "Mai")';
  ZQuery3.ExecSQL;
  ZQuery3.SQL.Text := 'INSERT INTO tblMonth VALUES (NULL, "Juni")';
  ZQuery3.ExecSQL;
  ZQuery3.SQL.Text := 'INSERT INTO tblMonth VALUES (NULL, "Juli")';
  ZQuery3.ExecSQL;
  ZQuery3.SQL.Text := 'INSERT INTO tblMonth VALUES (NULL, "August")';
  ZQuery3.ExecSQL;
  ZQuery3.SQL.Text := 'INSERT INTO tblMonth VALUES (NULL, "September")';
  ZQuery3.ExecSQL;
  ZQuery3.SQL.Text := 'INSERT INTO tblMonth VALUES (NULL, "Oktober")';
  ZQuery3.ExecSQL;
  ZQuery3.SQL.Text := 'INSERT INTO tblMonth VALUES (NULL, "November")';
  ZQuery3.ExecSQL;
  ZQuery3.SQL.Text := 'INSERT INTO tblMonth VALUES (NULL, "Dezember")';
  ZQuery3.ExecSQL;
  ZConnection1.commit;
          Application.OnException := @AppException;
  ...
  ZQuery1.Close;
  ZQuery1.SQL.Text := 'SELECT * FROM tblDateTime';
  ZQuery1.Open;

  ZQuery2.Close;
  ZQuery2.SQL.Text := 'SELECT * FROM tblJahr';
  ZQuery2.Open;

  ZQuery3.Close;
  ZQuery3.SQL.Text := 'SELECT * FROM tblMonth';
  ZQuery3.Open;
...
begin
  ...
  Form1.ZQuery2.active := False;
  Form1.ZQuery3.active := False;
  Form1.ZQuery4.active := False;
  ...
  // Form1.ZConnection1.CloseDataSets;
  // Form1.ZConnection1.Connected := False;
  Form1.ZConnection1.Free;
...
begin
  ...
  begin
    ...
    try
      ...
      m.AddPartBinaryFromFile('./log/crashreport2.log', p);
      m.AddPartBinaryFromFile('./log/log4delphi.log', p);
      ...
      DeleteFile('./log/log4delphi.log');
      DeleteFile('./log/crashreport2.log');
    end;
  end;
end;
